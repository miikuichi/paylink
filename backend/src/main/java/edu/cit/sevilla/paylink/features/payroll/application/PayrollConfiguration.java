...
public class PayrollConfiguration {
    ...
    static {
        ...
        TAX_BRACKETS.put("33333",
                new TaxBracket(new BigDecimal("33333"), new BigDecimal("20833"), new BigDecimal("0.20")));
        TAX_BRACKETS.put("66667", new TaxBracket(new BigDecimal("66667"), new BigDecimal("33333"),
                new BigDecimal("0.25"), new BigDecimal("2500")));
        TAX_BRACKETS.put("166667", new TaxBracket(new BigDecimal("166667"), new BigDecimal("66667"),
                new BigDecimal("0.30"), new BigDecimal("10833.33")));
        TAX_BRACKETS.put("666667", new TaxBracket(new BigDecimal("666667"), new BigDecimal("166667"),
                new BigDecimal("0.32"), new BigDecimal("40833.33")));
        TAX_BRACKETS.put("ABOVE", new TaxBracket(BigDecimal.ZERO, new BigDecimal("666667"), new BigDecimal("0.35"),
    ...
    public static final BigDecimal WORK_ON_REGULAR_HOLIDAY = new BigDecimal("2.00"); // 200% of daily rate (or 300% if
                                                                                     // rest day)
    public static final BigDecimal WORK_ON_SPECIAL_HOLIDAY = new BigDecimal("1.50"); // 150% of daily rate (or 200% if
                                                                                     // rest day)
    ...
    // Holidays are now managed in DB table `holiday_calendar` via Flyway migration
    // V2.
    // This allows admin updates for tentative and newly declared holidays without
    // redeploy.
