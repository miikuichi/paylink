  ...
  return (
    ...
    >
      <form className="auth-form" onSubmit={handleSubmit} noValidate>
        ...
        {success && <Alert tone="success">Account created! Redirecting you to sign in…</Alert>}
        ...
        <div className="field">
          ...
          <div className="auth-form__role-group">
            ...
            >
              ...
              <span className="auth-form__role-desc">View my payslips & payroll history</span>
            </button>
            <button
              type="button"
            ...
            >
              ...
              <span className="auth-form__role-desc">Manage employees & process payroll</span>
            </button>
          </div>
        </div>
        ...
        <label className="auth-form__terms">
          ...
          <span>
            I agree to the PayLink Terms of Service and acknowledge the Privacy Policy regarding payroll data
            handling.
          </span>
        </label>
        {errors.agree && (
